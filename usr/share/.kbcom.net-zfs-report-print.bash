...
ARC Efficiency - Breakdown:
 ...
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_PREFETCHDATAHITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394DDH ($LOCAL_INTEGER_PREFETCHDATAHITSDELTAPERCENTAGE%)" "\u0394DDM ($LOCAL_INTEGER_PREFETCHDATAMISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
 ...
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_PREFETCHMETADATAHITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394DMH ($LOCAL_INTEGER_PREFETCHDATAHITSDELTAPERCENTAGE%)" "\u0394DMM ($LOCAL_INTEGER_PREFETCHMETADATAMISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
}
