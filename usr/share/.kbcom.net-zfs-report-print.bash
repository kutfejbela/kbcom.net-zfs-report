...
print_arcefficiency_cachehitsbydatatype()
{
 ...
 LOCAL_INTEGER_HITSDEMANDDATAPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATS[demand_metadata_hits]} ${PARAMETER_ARRAY_ARCSTATS[hits]})
...
ARC Efficiency - Cache Hits by Data Type:
 ...
 then
  echo "
   $(print_4percentagebarmaximum20 $(( ${LOCAL_INTEGER_HITSDEMANDDATAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_HITSDEMANDMETADATAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_HITSPREFETCHDATAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_HITSPREFETCHMETADATAPERCENTAGE:0:-3} / 5 )) "MRU ($LOCAL_INTEGER_HITSDEMANDDATAPERCENTAGE%), MFU ($LOCAL_INTEGER_HITSDEMANDMETADATAPERCENTAGE%)" "MRU Ghost ($LOCAL_INTEGER_HITSPREFETCHDATAPERCENTAGE%), MFU Ghost ($LOCAL_INTEGER_HITSPREFETCHMETADATAPERCENTAGE%)")"
 fi
}
...
print_arcefficiency_cachemissesbydatatype()
{
 ...
 LOCAL_INTEGER_MISSESDEMANDDATAPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATS[demand_metadata_hits]} ${PARAMETER_ARRAY_ARCSTATS[hits]})
 LOCAL_INTEGER_MISSESDEMANDMETADATAPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATS[demand_metadata_hits]} ${PARAMETER_ARRAY_ARCSTATS[hits]})
 LOCAL_INTEGER_MISSESPREFETCHDATAPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATS[prefetch_data_hits]} ${PARAMETER_ARRAY_ARCSTATS[hits]})
 LOCAL_INTEGER_MISSESPREFETCHMETADATAPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATS[prefetch_metadata_hits]} ${PARAMETER_ARRAY_ARCSTATS[hits]})
...
ARC Efficiency - Cache Misses by Data Type:
 ...
 then
  echo "
   $(print_4percentagebarmaximum20 $(( ${LOCAL_INTEGER_MISSESDEMANDDATAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_MISSESDEMANDMETADATAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_MISSESPREFETCHDATAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_MISSESPREFETCHMETADATAPERCENTAGE:0:-3} / 5 )) "MRU ($LOCAL_INTEGER_MISSESDEMANDDATAPERCENTAGE%), MFU ($LOCAL_INTEGER_MISSESDEMANDMETADATAPERCENTAGE%)" "MRU Ghost ($LOCAL_INTEGER_MISSESPREFETCHDATAPERCENTAGE%), MFU Ghost ($LOCAL_INTEGER_MISSESPREFETCHMETADATAPERCENTAGE%)")"
 fi
}
