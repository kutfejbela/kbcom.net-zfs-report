...
ARC Size - Breakdown:
 \u2022 Most Recently Used Cache Size (p):
      ${PARAMETER_ARRAY_ARCSTATS[p]} ($(convert_byte_megabyte ${PARAMETER_ARRAY_ARCSTATS[p]}) MB - $LOCAL_INTEGER_MRUPERCENTAGE%)
 \u2022 Most Frequently Used Cache Size (c-p):
      $LOCAL_INTEGER_MFU ($(convert_byte_megabyte $LOCAL_INTEGER_MFU) MB - $LOCAL_INTEGER_MFUPERCENTAGE%)"

 if ! ( [ "$LOCAL_INTEGER_MRUPERCENTAGE" = "0.00" ] && [ "$LOCAL_INTEGER_MFUPERCENTAGE" = "0.00" ] )
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_MRUPERCENTAGE:0:-3} / 5 )) "MRU ($LOCAL_INTEGER_MRUPERCENTAGE%)" "MFU ($LOCAL_INTEGER_MFUPERCENTAGE%)")"
 fi
}
...
ARC Efficiency - Total:
 ...
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_HITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394Hits ($LOCAL_INTEGER_HITSDELTAPERCENTAGE%)" "\u0394Misses ($LOCAL_INTEGER_MISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
}
...
ARC Efficiency - Breakdown:
 ...
 then
  echo -n "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_DEMANDDATAHITSPERCENTAGE:0:-3} / 5 )) " DDH ($LOCAL_INTEGER_DEMANDDATAHITSPERCENTAGE%)" " DDM ($LOCAL_INTEGER_DEMANDDATAMISSESPERCENTAGE%)")"
 fi

 if ! ( [ "$LOCAL_INTEGER_DEMANDDATAHITSDELTAPERCENTAGE" = "0.00" ] && [ "$LOCAL_INTEGER_DEMANDDATAMISSESDELTAPERCENTAGE" = "0.00" ] )
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_DEMANDDATAHITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394DDH ($LOCAL_INTEGER_DEMANDDATAHITSDELTAPERCENTAGE%)" "\u0394DDM ($LOCAL_INTEGER_DEMANDDATAMISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
 ...
 then
  echo -n "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_DEMANDMETADATAHITSPERCENTAGE:0:-3} / 5 )) " DMH ($LOCAL_INTEGER_DEMANDMETADATAHITSPERCENTAGE%)" " DMM ($LOCAL_INTEGER_DEMANDMETADATAMISSESPERCENTAGE%)")"
 fi

 if ! ( [ "$LOCAL_INTEGER_DEMANDMETADATAHITSDELTAPERCENTAGE" = "0.00" ] && [ "$LOCAL_INTEGER_DEMANDMETADATAMISSESDELTAPERCENTAGE" = "0.00" ] )
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_DEMANDMETADATAHITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394DMH ($LOCAL_INTEGER_DEMANDMETADATAHITSDELTAPERCENTAGE%)" "\u0394DMM ($LOCAL_INTEGER_DEMANDMETADATAMISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
 ...
 then
  echo -n "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_PREFETCHDATAHITSPERCENTAGE:0:-3} / 5 )) " PDH ($LOCAL_INTEGER_PREFETCHDATAHITSPERCENTAGE%)" " PDM ($LOCAL_INTEGER_PREFETCHDATAMISSESPERCENTAGE%)")"
 fi

 if ! ( [ "$LOCAL_INTEGER_PREFETCHDATAHITSDELTAPERCENTAGE" = "0.00" ] && [ "$LOCAL_INTEGER_PREFETCHDATAMISSESDELTAPERCENTAGE" = "0.00" ] )
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_PREFETCHDATAHITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394PDH ($LOCAL_INTEGER_PREFETCHDATAHITSDELTAPERCENTAGE%)" "\u0394PDM ($LOCAL_INTEGER_PREFETCHDATAMISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
 ...
 then
  echo -n "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_PREFETCHMETADATAHITSPERCENTAGE:0:-3} / 5 )) " PMH ($LOCAL_INTEGER_PREFETCHMETADATAHITSPERCENTAGE%)" " PMM ($LOCAL_INTEGER_PREFETCHMETADATAMISSESPERCENTAGE%)")"
 fi

 if ! ( [ "$LOCAL_INTEGER_PREFETCHMETADATAHITSDELTAPERCENTAGE" = "0.00" ] && [ "$LOCAL_INTEGER_PREFETCHMETADATAMISSESDELTAPERCENTAGE" = "0.00" ] )
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_PREFETCHMETADATAHITSDELTAPERCENTAGE:0:-3} / 5 )) "\u0394PMH ($LOCAL_INTEGER_PREFETCHMETADATAHITSDELTAPERCENTAGE%)" "\u0394PMM ($LOCAL_INTEGER_PREFETCHMETADATAMISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
}
...
ARC Efficiency - Cache Hits by Cache List:
 ...
 then
  echo "
   $(print_4percentagebarmaximum20 $(( ${LOCAL_INTEGER_MRUDELTAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_MFUDELTAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_MRUGHOSTDELTAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_MFUGHOSTDELTAPERCENTAGE:0:-3} / 5 )) "\u0394MRU ($LOCAL_INTEGER_MRUDELTAPERCENTAGE%), \u0394MFU ($LOCAL_INTEGER_MFUDELTAPERCENTAGE%)" "\u0394MRU Ghost ($LOCAL_INTEGER_MRUGHOSTDELTAPERCENTAGE%), \u0394MFU Ghost ($LOCAL_INTEGER_MFUGHOSTDELTAPERCENTAGE%)")"
 fi
}
...
ARC Efficiency - Cache Hits by Data Type:
 ...
 then
  echo "
   $(print_4percentagebarmaximum20 $(( ${LOCAL_INTEGER_HITSDEMANDDATADELTAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_HITSDEMANDMETADATADELTAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_HITSPREFETCHDATADELTAPERCENTAGE:0:-3} / 5 )) $(( ${LOCAL_INTEGER_HITSPREFETCHMETADATADELTAPERCENTAGE:0:-3} / 5 )) "\u0394DDH ($LOCAL_INTEGER_HITSDEMANDDATADELTAPERCENTAGE%), \u0394DMH ($LOCAL_INTEGER_HITSDEMANDMETADATADELTAPERCENTAGE%)" "\u0394PDH ($LOCAL_INTEGER_HITSPREFETCHDATADELTAPERCENTAGE%), \u0394PMH ($LOCAL_INTEGER_HITSPREFETCHMETADATADELTAPERCENTAGE%)")"
 else
  echo
 fi
}
...
L2ARC Efficiency:
 ...
 then
  echo -n "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_L2HITSPERCENTAGE:0:-3} / 5 )) " L2 Hits ($LOCAL_INTEGER_L2HITSPERCENTAGE%)" " L2 Misses ($LOCAL_INTEGER_L2MISSESPERCENTAGE%)")"
 fi

 if ! ( [ "$LOCAL_INTEGER_L2HITSDELTAPERCENTAGE" = "0.00" ] && [ "$LOCAL_INTEGER_L2MISSESDELTAPERCENTAGE" = "0.00" ] )
 then
  echo "
   $(print_percentagebar20 $(( ${LOCAL_INTEGER_L2HITSPERCENTAGE:0:-3} / 5 )) "\u0394L2 Hits ($LOCAL_INTEGER_L2HITSDELTAPERCENTAGE%)" "\u0394L2 Misses ($LOCAL_INTEGER_L2MISSESDELTAPERCENTAGE%)")"
 else
  echo
 fi
}
