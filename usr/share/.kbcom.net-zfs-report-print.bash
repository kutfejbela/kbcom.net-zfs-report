...
print_arcsize_total()
{
 ...
 LOCAL_INTEGER_SIZEPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATS[size]} ${PARAMETER_ARRAY_ARCSTATS[c]})
 LOCAL_INTEGER_SIZELOGPERCENTAGE=$(calculate_percentage ${PARAMETER_ARRAY_ARCSTATSLOG[size]} ${PARAMETER_ARRAY_ARCSTATSLOG[c]})

 echo -e "
Arc Size - Total:
 \u2022 Current Size (size):
      ${PARAMETER_ARRAY_ARCSTATS[size]} ($(convert_byte_megabyte ${PARAMETER_ARRAY_ARCSTATS[size]}) MB - $LOCAL_INTEGER_SIZEPERCENTAGE%) \u279f ${PARAMETER_ARRAY_ARCSTATSLOG[size]} ($(convert_byte_megabyte ${PARAMETER_ARRAY_ARCSTATSLOG[size]}) MB - $LOCAL_INTEGER_SIZELOGPERCENTAGE%)
 \u2022 Target Size (c):
      ${PARAMETER_ARRAY_ARCSTATS[c]} ($(convert_byte_megabyte ${PARAMETER_ARRAY_ARCSTATS[c]}) MB) \u279f ${PARAMETER_ARRAY_ARCSTATSLOG[c]} ($(convert_byte_megabyte ${PARAMETER_ARRAY_ARCSTATSLOG[c]}) MB)
 \u2022 Minimum Size (c_min):
 ...
 echo "
  $(print_percentagebar20 $(( ${LOCAL_INTEGER_SIZEPERCENTAGE:0:-3} / 5 )) $(printf ' Current Size (%*s%s%%)' 6 "$LOCAL_INTEGER_SIZEPERCENTAGE") "")
  $(print_percentagebar20 $(( ${LOCAL_INTEGER_SIZELOGPERCENTAGE:0:-3} / 5 )) $(printf '\u279fCurrent Size (%*s%s%%)' 6 "$LOCAL_INTEGER_SIZELOGPERCENTAGE") "")"
}
